...
const fr: Messages = {
  ...
  'customize.keyboard.lower': "Touches blanches de l'octave basse",
  ...
  'customize.keyboard.extended.white': 'Touches blanches étendues',
  'customize.keyboard.extended.black': 'Touches noires étendues',
  'customize.keyboard.extended.shiftHeld': 'Maj change les touches tenues',
  'customize.keyboard.extended.shiftHeld.sub': 'Appuyez sur Maj en tenant une touche pour alterner blanche et noire',

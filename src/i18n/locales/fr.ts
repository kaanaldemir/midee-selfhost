...
const fr: Messages = {
  ...
  'customize.keyboard.extended.shiftHeld': 'Maj sur touches tenues',
  'customize.keyboard.extended.shiftHeld.sub': 'Appuyez sur Maj en tenant une touche pour ajouter sa noire',

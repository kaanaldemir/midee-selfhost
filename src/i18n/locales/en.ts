...
export const en = {
  ...
  'customize.keyboard.lower': 'Lower octave white keys',
  ...
  'customize.keyboard.extended.shiftHeld': 'Shift switches held keys',
  'customize.keyboard.extended.shiftHeld.sub': 'Press Shift while holding a key to swap white and black',

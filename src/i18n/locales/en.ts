...
export const en = {
  ...
  'customize.keyboard.lower': 'Lower letter row',
  'customize.keyboard.middle': 'Middle letter row',
  'customize.keyboard.upper': 'Upper letter row',
  'customize.keyboard.numbers': 'Number row',
